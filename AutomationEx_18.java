...
public class AutomationEx_18 extends TestBaseRapor {
    ...
    public void test18_View_Category_Products() throws InterruptedException {
        ...
        ReusableMethods.verifyURLorText(automationExPage.productPageTopTitleText.getText().toUpperCase(), "Women - Dress Products");
        ...
        js.executeScript("arguments[0].scrollIntoView();", automationExPage.productPageTopTitleText);
        ReusableMethods.verifyURLorText(automationExPage.productPageTopTitleText.getText().toUpperCase(), "Men - Tshirts Products");
